  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="flex-1 p-6">
        {currentStep === 0 && <AdSelectionStep onAdSelect={handleAdSelect} state="California" stateCode="CA" />}
        {currentStep === 1 && (
          <CheckoutStep onNext={() => setCurrentStep(2)} state="California" selectedAd={selectedAd} />
        )}
        {currentStep === 2 && <OrderSummaryStep state="California" selectedAd={selectedAd} />}
      </main>
