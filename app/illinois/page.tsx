  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="flex-1 p-6">
        ...
        {currentStep === 1 && (
          <CheckoutStep onNext={() => setCurrentStep(2)} state="Illinois" selectedAd={selectedAd} />
        )}
        {currentStep === 2 && <OrderSummaryStep state="Illinois" selectedAd={selectedAd} />}
      </main>
        ...
        <div>
          ...
          <div className="space-y-6">
            <AdOption
              ...
              remaining="55/100 REMAINING"
              price={500}
              onBuy={handleBuyClick}
            />
            <AdOption
              title="1/4 PAGE ADVERTORIAL - 1000"
              remaining="6/10 REMAINING"
              price={1000}
              onBuy={handleBuyClick}
            />
            <AdOption
              ...
              onBuy={handleBuyClick}
            />
            <AdOption title="FULL PAGE AD - 2500" remaining="4/10 REMAINING" price={2500} onBuy={handleBuyClick} />
          </div>
  ...
  return (
    <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div>
        ...
        <div className="space-y-6">
          <div>
            <h3 className="text-xl font-bold mb-4 text-green-500">{selectedAd?.title || "SELECTED AD"}</h3>
            <div className="space-y-4">
              <div>
