  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="flex-1 p-6">
        ...
        {currentStep === 1 && (
          <CheckoutStep onNext={() => setCurrentStep(2)} state="Missouri" selectedAd={selectedAd} />
        )}
        {currentStep === 2 && <OrderSummaryStep state="Missouri" selectedAd={selectedAd} />}
      </main>
        ...
        <div>
          ...
          <div className="space-y-6">
            <AdOption
              ...
              remaining="85/100 REMAINING"
              price={500}
              onBuy={handleBuyClick}
            />
            <AdOption
              title="1/4 PAGE ADVERTORIAL - 1000"
              remaining="9/10 REMAINING"
              price={1000}
              onBuy={handleBuyClick}
            />
            <AdOption
              ...
              onBuy={handleBuyClick}
            />
            <AdOption title="FULL PAGE AD - 2500" remaining="8/10 REMAINING" price={2500} onBuy={handleBuyClick} />
          </div>
